...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post contributions_url, params: { contribution: { diff: @contribution.diff, post_id: @contribution.post_id, user_id: @contribution.user_id } }
    end
  ...
  test "should update contribution" do
    patch contribution_url(@contribution), params: { contribution: { diff: @contribution.diff, post_id: @contribution.post_id, user_id: @contribution.user_id } }
